...
\position{QA Engineer{\enskip\cdotp\enskip}BlueOcean Tech QA Team} % Your expertise/fields


\makecvfooter{\today}{Reynier González Vega~~~·~~~Résumé}{\thepage} % Specify the letter footer with 3 arguments: (<left>, <center>, <right>), leave any of these blank if they are not needed
